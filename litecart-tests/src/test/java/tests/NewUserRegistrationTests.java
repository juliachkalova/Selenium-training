...
public class NewUserRegistrationTests extends BaseTestClass {
    ...
    public void Test01_NewUserRegistration() {
        ...
        driver.findElement(By.name("email")).sendKeys("juliatest120@mailinator.com");
        ...
        loginForm.findElement(By.cssSelector("input[name=email]")).sendKeys("juliatest120@mailinator.com");
